...
const FOREIGN_PEOPLE = [
  ...
  },
  {
    ...
    bio: '本杰明·格雷厄姆是现代价值投资理论的奠基人，也是巴菲特在哥伦比亚商学院的恩师。他历经1929年大崩盘，从中提炼出"安全边际"理论。他写下的两本书——《证券分析》（1934）和《聪明的投资者》（1949）——至今仍是价值投资的圣经。巴菲特称《聪明的投资者》是他"读过的最好的投资书"。',
    achievements: [
  ...
  },
  {
    ...
    bio: '约翰·邓普顿是全球化价值投资的开拓者。1939年二战爆发时，他借钱买入104只价格低于1美元的纽约股票，4年后几乎全部盈利。他率先将价值投资扩展到全球市场，在日本、德国、加拿��等市场寻找被低估的优质企业。他坚信"在最悲观的时刻买入"，成为逆向投资的代表人物。',
    achievements: [
  ...
  },
  {
    ...
    bio: '塞思·卡拉曼是当代最受尊重的价值投资者之一。他的著作《安全边际》（1991）绝版后在二手市场价格高达数千���元，被称为"投资圣经"。Baupost Group以绝对回报为目标，擅长不良债务、私募股权和特殊情况投资。卡拉曼极度注重风险控制，常持有大量现金等待合适机会，堪称"安全边际"原则最彻底的践行者。',
    achievements: [
  ...
  },
  {
    ...
    bio: '乔尔·格林布拉特以"神奇公式"（Magic Formula）闻名——用高盈利收益率和高资本回报率选股，在20年的回测中年化回报超过30%。他的戈坦资本在1985年至2005年间实现年化约40%的惊人回报，主要专注于特殊情况投资和分拆企业。他的两本书以极简语言阐释了价值投资的核心，成为最易读的投资经典。',
    achievements: [
      '戈坦资本1985–2005年年化回报约40%',
      '提出"神奇公式"，将价值投资系统化为可量化的选股工具',
      '长期在哥伦比亚商学院教授价值投资',
      '投资特殊情况：分拆、破产重组、并购套利',
    ],
    influences: ['本杰明·格雷厄姆', '沃伦·巴菲特'],
    keyQuote: '如果你不知道如何为一家企业估值，那你就不应该投资它的股票。',
    books: ['《股市天才》（1997）', '《你能成为股市天才》', '《神奇公式》（2005）'],
  },
]
...
const CHINESE_PEOPLE = [
  ...
  },
  {
    ...
    bio: '林园是中国A股市场最具传奇色彩的个人投资者之一，被称为"中国巴菲特"。1989年以8000元入市，通过集中持有医药消费龙头企业，资产增长至数十亿元。他极度集中持仓（通常只持有3-5只股票），偏好具有定价权和消费垄断特征的企业，长期重仓茅台、片仔癀、云南白药等医药消费股，是A股价值投资的标志性人物。',
    achievements: [
      '从8000元起步，30余年实现资产数十亿元的增长',
      '长期重仓茅台等消费医药龙头，深度践行集中价值投资',
      '创立林园投资，管理多只私募基金',
      '以"我只买我看得懂的企业"的投资哲学影响中国投资界',
    ],
    influences: ['沃伦·巴菲特', '彼得·林奇'],
    keyQuote: '我买股票只买我看得懂的企业，它们能赚钱，而且是大量赚钱的那种。',
    books: ['《林园炒股秘籍》（访谈录）'],
  },
  {
    name: '但斌',
    ...
    bio: '但斌是中国最早将巴菲特长期价值投资理念系统引入A股的基金管理人之一。他长期持有茅台、腾讯等消费互联网龙头，曾以茅台为例撰写多篇分析文章，引发广泛讨论。其著作《时间的玫瑰》讲述了他对价值投资的理解，以及长期陪伴优秀企业成长的投资逻辑，是中国私募基金界的代表人物。',
    achievements: [
      '东方港湾成立以来长期持有消费龙头，实现超额回报',
      '《时间的玫瑰》成为中国价值投资入门必读书籍',
      '最早在A股系统践行"买入并持有优秀企业"策略',
      '频繁参与公开讨论，推动价值投资理念在中国的普及',
    ],
    influences: ['沃伦·巴菲特', '查理·芒格', '彼得·林奇'],
    keyQuote: '伟大的企业会用时间来证明自己的价值，耐心持有是对优秀企业最大的尊重。',
    books: ['《时间的玫瑰》（2007）'],
  },
  {
    name: '邱国鹭',
    ...
    bio: '邱国鹭是高毅资产的核心创始人之一，曾任南方基金投资总监，以深度基本面研究和价���投资方法论著称。他长期研究消费、医药、金融等行业的优质龙头企业，以"买股票就是买企业"的理念指导投资决策。其著作《投资中最简单的事》以通俗语言阐述了A股价值投资的核心方法论，成为中国专业投资者的重要参考读物。',
    achievements: [
      '曾任南方基金投资总监，管理资产超百亿元',
